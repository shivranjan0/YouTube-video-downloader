...
export default function PixelCard({
  ...
  return (
    <div
      ...
      onMouseEnter={() => !disabled && handleAnimation('appear')}
      onMouseLeave={() => !disabled && handleAnimation('disappear')}
      onFocus={
        finalNoFocus
          ? undefined
          : e => {
              if (!e.currentTarget.contains(e.relatedTarget as Node)) handleAnimation('appear');
            }
      }
      onBlur={
        finalNoFocus
          ? undefined
          : e => {
              if (!e.currentTarget.contains(e.relatedTarget as Node)) handleAnimation('disappear');
            }
      }
